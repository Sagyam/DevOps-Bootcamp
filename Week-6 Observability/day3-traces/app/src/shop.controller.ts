...
export class ShopController {
  ...
  @Get('teas/:id/pairings')
  @ApiOperation({
    summary: 'Recommended pairings for a tea. Deliberately slow -- this is the endpoint we trace.',
  })
  pairings(@Param('id', ParseIntPipe) id: number) {
    return this.shop.pairings(id);
  }
